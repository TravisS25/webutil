...
// StorageReaderWriter is an autogenerated mock type for the StorageReaderWriter type
type StorageReaderWriter struct {
	mock.Mock
}

// GetObject provides a mock function with given fields: bucketName, objectName, opts
func (_m *StorageReaderWriter) GetObject(bucketName string, objectName string, opts minio.GetObjectOptions) (*minio.Object, error) {
...
func (_m *StorageReaderWriter) PresignedGetObject(bucketName string, objectName string, expiry time.Duration, reqParams url.Values) (*url.URL, error) {
...
func (_m *StorageReaderWriter) PutObject(bucketName string, objectName string, reader io.Reader, objectSize int64, opts minio.PutObjectOptions) (int64, error) {
...
func (_m *StorageReaderWriter) RemoveObject(bucketName string, objectName string) error {
