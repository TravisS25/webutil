...
func (_m *MockDBInterface) Beginx() (*sqlx.Tx, error) {
	ret := _m.Called()
...
func (_m *MockDBInterface) QueryRowx(query string, args ...interface{}) *sqlx.Row {
	var _ca []interface{}
...
func (_m *MockDBInterface) Queryx(query string, args ...interface{}) (*sqlx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
