...
func (_m *MockDBInterface) Begin() (*sql.Tx, error) {
	ret := _m.Called()
...
func (_m *MockDBInterface) Commit(tx *sql.Tx) error {
	ret := _m.Called(tx)
...
func (_m *MockDBInterface) Exec(_a0 string, _a1 ...interface{}) (sql.Result, error) {
	var _ca []interface{}
	_ca = append(_ca, _a0)
	_ca = append(_ca, _a1...)
	ret := _m.Called(_ca...)
...
func (_m *MockDBInterface) Get(dest interface{}, query string, args ...interface{}) error {
	var _ca []interface{}
...
func (_m *MockDBInterface) Query(query string, args ...interface{}) (*sql.Rows, error) {
	var _ca []interface{}
...
func (_m *MockDBInterface) QueryRow(query string, args ...interface{}) *sql.Row {
	var _ca []interface{}
	_ca = append(_ca, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *MockDBInterface) Select(dest interface{}, query string, args ...interface{}) error {
	var _ca []interface{}
	_ca = append(_ca, dest, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
