...
// MockQuerierExec is an autogenerated mock type for the QuerierExec type
type MockQuerierExec struct {
	mock.Mock
}

// Exec provides a mock function with given fields: _a0, _a1
func (_m *MockQuerierExec) Exec(_a0 string, _a1 ...interface{}) (sql.Result, error) {
	var _ca []interface{}
	_ca = append(_ca, _a0)
	_ca = append(_ca, _a1...)
	ret := _m.Called(_ca...)
...
func (_m *MockQuerierExec) QueryRowx(query string, args ...interface{}) *sqlx.Row {
	var _ca []interface{}
...
func (_m *MockQuerierExec) Queryx(query string, args ...interface{}) (*sqlx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
